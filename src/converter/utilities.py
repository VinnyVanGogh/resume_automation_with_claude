...
class SystemInfo:
    ...
    def validate_environment() -> list[str]:
        ...
        for dep in optional_deps:
            if not deps.get(dep, False):
                issues.append(
                    f"Optional dependency missing: {dep} (some features may not work)"
                )
...
class FormatUtils:
    ...
    @staticmethod
    def detect_format_from_file(file_path: Path) -> str | None:
        """
...
class ThemeUtils:
    ...
    def get_theme_info(theme_name: str) -> dict[str, Any]:
        ...
        return {
            "name": theme_name,
            "description": ThemeUtils.THEME_DESCRIPTIONS.get(
                theme_name, "No description available"
            ),
...
class ConfigUtils:
    ...
    def validate_config_file(config_path: str | Path) -> dict[str, Any]:
        ...
        result["is_valid"] = (
            ...
            and result["yaml_valid"]
            and result["schema_valid"]
            and result["business_rules_valid"]
        )
...
class ResultUtils:
    ...
    def analyze_conversion_result(result: ConversionResult) -> dict[str, Any]:
        ...
        analysis = {
            ...
            "performance": {
                ...
                "files_per_second": (
                    1 / result.processing_time if result.processing_time > 0 else 0
                ),
    ...
    def analyze_batch_result(batch_result: BatchConversionResult) -> dict[str, Any]:
        ...
        analysis = {
            ...
            "quality": {
                "average_quality_score": ResultUtils._calculate_average_quality_score(
                    individual_analyses
                ),
    ...
    def export_results_to_json(
        results: ConversionResult | BatchConversionResult,
