...
"""
    ...
    def test_error_handling_integration(self):
        ...
        result = converter.convert(
            input_path=self.temp_dir / "nonexistent.md",
            output_dir=self.output_dir
        )
...
"""
    ...
    def test_end_to_end_with_file_management(self):
        ...
        result = converter.convert(
            input_path=self.sample_resume_file,
            output_dir=self.temp_dir / "temp_output"
        )
        ...
        organized_files, report = file_manager.organize_output_files(
            ...
            source_file=self.sample_resume_file
        )
...
class TestErrorRecovery:
    ...
    def test_partial_failure_recovery(self):
        ...
        valid_file.write_text("# Valid Resume\ntest@example.com\n\n## Experience\nTest job")
